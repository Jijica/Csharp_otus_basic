namespace Program3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            PrintPlanetInfo(catalog.GetPlanet("Limonia", PlanetValidator), "Limonia");
            PrintPlanetInfo(catalog.GetPlanet("Limonia", planet => planet == "Limonia" ? "This is a forbidden planet!" : null!), "Limonia");
            PrintPlanetInfo(catalog.GetPlanet("Mars", PlanetValidator), "Mars");
            PrintPlanetInfo(catalog.GetPlanet("Venus", PlanetValidator), "Venus");
            PrintPlanetInfo(catalog.GetPlanet("Mars", PlanetValidator), "Mars");
            PrintPlanetInfo(catalog.GetPlanet("Mercury", planet => planet == "Limonia" ? "This is a forbidden planet!" : null!), "Mercury");
